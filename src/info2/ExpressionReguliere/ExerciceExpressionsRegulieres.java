 ...
 * @version 1.0
 */
public class ExerciceExpressionsRegulieres {
    ...
    public static void numeroSalle() {
        ...
        String[] chaineIncorrecte = { "A30", "D300", "4", "A4", "A4565", "4A", "300A", "a201", "a3004"};
     ...
     * Éventuellement, elles peuvent contenir un chiffre décimal.
    ...
    public static void note() {
        ...
        String regex = "((1?[\\d])|(20))(,[\\d])?";

        // jeux de tests
        String[] chaineCorrecte = { "20", "12", "15,6", "9,9", "0", "20,0", "5,0", "20"};
        String[] chaineIncorrecte = { "05", "456", "22", "45"};
    ...
    public static void horaire() {
         ...
         * suivi d'un chiffre
         */
        String regex  = "(([01][\\d])|(2[0123]))(h|H)([0-5][\\d])";
    ...
    public static void paquetageJava() {
        ...
        String[] chaineIncorrecte = { "General", "21apijava", "java.Util"};
    ...
    public static void prenom() {
        ...
        String[] chaineIncorrecte = { "marie", "Jean-", "MARIE", "MarieHelene", "Marie.Helene"};
    ...
    public static void commande() {
         ...
         */
        String regex = "( )*((\\?|[qQ])|(([vV]|[dD]|[sS])( )+[\\d])|([cC]|[eE])( )+[\\d]( )+[\\d]+)( )*";
        // ou  "\\s*[Ee]\\s+\\d\\s+\\d+\\s*"

        // jeux de tests
        String[] chaineCorrecte = { "E   5   236", "  E 6 1", "e   4 0 ",
                "S 4 ", "  C   9   0   ", "d 0  ",
                "s 9", "c 1 1", "E  8  02", "C  4  0001", "        Q            "};
