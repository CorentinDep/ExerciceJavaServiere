...
public class TestPileGenString {
     ...
     */
    private static void testCreationPileVide(PileGenerique<String> p, String nomPile){
        if (p.estVide()) {
     ...
     */
    private static void testCapacite(PileGenerique<String> p, PileGenerique<String> identique, PileGenerique<String> differente) {
     ...
     */
    private static void testEgalite(PileGenerique<String> p, PileGenerique<String> identique, PileGenerique<String> differente) {
